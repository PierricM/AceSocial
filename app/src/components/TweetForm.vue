        ...
        <div class="flex flex-wrap items-center justify-between -m-2">
            ...
            <div class="relative m-2 mr-4">
                ...
                <div class="absolute left-0 inset-y-0 flex pl-3 pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto" :class="effectiveTopic ? 'text-blue-700' : 'text-gray-400'" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="flex items-center space-x-6 m-2 ml-auto">
                ...
                <button
                    ...
                    :class="canTweet ? 'bg-blue-700' : 'bg-blue-500 cursor-not-allowed'"
                    @click="send"
                >
                    Tweet
                </button>
